...
<div class="container">
    <div class="container rounded" style="background-color: #f2f2f2; border-radius: 30px; justify-content: center; padding: 30px;">
                ...
                <div style="padding: .5rem 1rem;">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group-append">
                          <button class="btn-warning" onclick="return modal_change_password()" type="button">เปลี่ยนรหัสผ่าน</button>
                        </div>
                    </div>
                    ...
                    <button class="btn-success" id="Save"><i class="glyphicon glyphicon-floppy-save"></i>&nbsp;บันทึก</button>
                    <button class="btn-primary" onclick="window.location.href='/home'"><i class="glyphicon glyphicon-floppy-save"></i>&nbsp;ยกเลิก</button>  
                </div> 
            </form>
